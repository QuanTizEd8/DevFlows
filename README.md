...
| Documents  | `pandoc`             | Convert documents with official Pandoc Docker images, with uniform checkout, artifact, and optional patch-emit channels.                          | [reference](https://quantized8.github.io/DevFlows/reference/workflows/pandoc.html)             |
...
| Utilities  | `writeback`          | Apply a patch artifact to a checked-out branch and push it — the sole commit executor callers compose behind a workflow's patch-emit channel.     | [reference](https://quantized8.github.io/DevFlows/reference/workflows/writeback.html)          |
